...
public class Demo1_Math {
	...
	* B:成员方法
		...
		* public static double ceil(double a)   向上取数  如： 12.1   向上取数为 13
		* public static double floor(double a)   向下取数  如： 12.1  向下取数为 12
		* public static int max(int a,int b) min自学   
		* public static double pow(double a,double b)   以a为低的b次幂的值
		* public static double random()     	生成0.0到1.0之间的所有小数,左闭右开
		* public static int round(float a) 参数为double的自学     四舍五入
		* public static double sqrt(double a)    对a进行开根
	 */
