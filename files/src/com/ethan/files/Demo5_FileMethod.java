...
public class Demo5_FileMethod {
	...
	public static void main(String[] args) {
		//demo1();
		File dir = new File("/home/sam/桌面/day19(异常&IO(File类))");
	...
	public static void demo1() {
		File file1 = new File("/home/sam/桌面/day19(异常&IO(File类))");
		File file2 = new File("/home/sam/桌面");
...
/*		System.out.println(file1.getName());					//获取构造方法中文件或者文件的名字
